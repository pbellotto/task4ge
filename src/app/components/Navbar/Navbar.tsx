...
import { BellIcon, Bars3Icon, XMarkIcon, MapIcon } from '@heroicons/react/24/outline';
import Link from 'next/link';

const navigation = [
    { name: 'Home', href: '/', needAuthentication: false, current: true },
    { name: 'Tasks', href: '/tasks', needAuthentication: true, current: false },
]
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            ...
                            <Menu as="div" className="relative ml-3">
                                ...
                                >
                                    ...
                                    <MenuItem>
                                        <Link href="/api/auth/logout" className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100">
                                            Logout
                                        </Link>
                                    </MenuItem>
                                </MenuItems>
